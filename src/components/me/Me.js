...
ומאחר והייתי חיה בסבל הזה כ״כ הרבה שנים, אני יודעת על בשרי מה כל אישה חווה בסקאלה של העליה והירידה במשקל. 
        ...
        <p className={styles.description}>בשנה האחרונה ליוותי כ300 נשים לאיזון משקל עודף כמלווה ומאמנת תזונה בתוכנית מוכרת של רופא בתחום הרפואה הטבעית בארץ.</p>
...
כתחביב למדתי הוראה ליוגה ואיזון הנפש ברוח היהדות. ובנוסף - עוד המון שיטות, תהליכים ומידע בהקשר לגוף ולנפש שלנו.
